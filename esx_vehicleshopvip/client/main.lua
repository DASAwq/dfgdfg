-- This is the new client/main.lua file for esx_vehicleshopvip
-- This is the new client/main.lua file for esx_vehicleshopvip
...
function OpenShopMenu()
    ...
    for i = 1, #Categories, 1 do
        ...
        for j = 1, #categoryVehicles, 1 do
            ...
            table.insert(options, ('%s <span style="color:green;">%s VIP Coins</span>'):format(vehicle.name, vehicle.price))
        end
    ...
    if firstVehicleData then
        ...
        print('[^3ERROR^7] No valid vehicles available to display.')
    end
end
